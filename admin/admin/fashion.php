...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			...
			<form id="myForm" style="display:none;" action="fashion_insert.php" method="POST" enctype="multipart/form-data">
...
if (mysqli_num_rows($result) > 0) {
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		echo '<td>
			<a href="fashion_delete.php?id=' . $row['fashion_id'] . '" class="text-decoration-none btn  btn-outline-danger">Delete</a>
			</td>
			</tr>';
	}
	echo '</table>';
